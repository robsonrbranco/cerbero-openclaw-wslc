...
| `gemini_36_flash.patch.json5` | Registra `gemini-3.6-flash` (1M ctx, $1,50/$7,50 por 1M tok, specs conferidas via WebSearch) e substitui o fallback #1 (era `gemini-3.5-flash`) por ele | 24/07/2026 |
